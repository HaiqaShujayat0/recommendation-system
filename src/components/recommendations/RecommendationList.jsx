    ...
    <div className="flex flex-col h-[calc(100vh-72px)]">
      ...
      <div className="flex-shrink-0 mb-3">
        <div className="card p-5">
          {/* Purple accent bar */}
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-accent-400 via-primary-500 to-accent-500 rounded-t-2xl" />
          <div className="flex items-center justify-between relative">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-0.5">
                Evidence-based medication recommendations generated by GLYERAL.
              </p>
            </div>
            {!recommendations ? (
              <Button
      ...
      {/* ── Split pane: Recommendations | Chat ── */}
      <div className="flex gap-5 flex-1 min-h-0">
        {/* Left column — scrollable recommendations */}
        <div className="flex-1 min-w-0 max-w-4xl overflow-y-auto px-1 pb-2 scrollbar-thin">
          {/* Loading state */}
          {loading && (
        ...
        {/* Right column — AI Chat (fills available height) */}
